...
<head>
	<title>Deducciones Mes Planilla</title>
...
<body class = "body">
	...
	<div class="div">
		<br>
		<h1 class="h2">Deducciones del mes</h1>	
	...
	<?php
		...
		if (isset($_GET['id'])){
			...
			$idEmpleado = $_GET['id'];
            $idMesPlanilla = $_GET['idMes'];
			$query = "EXEC dbo.ConsultarDeduccionesDeMes $idEmpleado, $idMesPlanilla, 0";
